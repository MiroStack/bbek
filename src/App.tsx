        ...
        <Routes>
          ...
          <Route path="/landpage" element={<LandPage />}>
            ...
            <Route path="about" element={<AboutPage />}>
              ...
              <Route
                index
                path="leadersandofficers"
                element={<LeadersAndOfficers />}
              ></Route>
            ...
            <Route path="beoneofus" element={<BeOneOfUsPage />}>
              <Route
                index
                path="waterbaptism"
                element={<WaterBaptismPage />}
              ></Route>
              <Route
                index
                path="sendprayer"
                element={<SendPrayerPage />}
              ></Route>
            </Route>
            ...
            <Route path="ministries" element={<MinistryPage />}>
              ...
              ></Route>
              <Route
                path="learn-more-ministry"
                element={<LearnMoreMinistries />}
              ></Route>
            </Route>
          ...
          <Route path="/admin" element={<AdminPage />}>
            ...
            <Route
              index
              path="church-record/church-leaders"
              element={<ChurchLeadersAdminPage />}
            />
            <Route
              index
              path="church-record/department-officers"
              element={<DepartmentOfficersAdminPage />}
            />
            <Route
              index
            ...
            <Route
              index
              path="church-record/event-record"
              element={<EventRecordPageAdmin />}
            />
            <Route
              index
            ...
            <Route
              index
              path="church-record/marriage-record"
              element={<MarriageRecordPage />}
            />

            <Route
              index
              path="service/waterbaptism"
              element={<WaterBaptismAdminPage />}
            />
            <Route
              index
              path="service/child-dedication"
              element={<ChildDedicationAdminPage />}
            />
            <Route
              index
              path="service/marriage-record"
              element={<MarriageServiceAdminPage />}
            />

            <Route
              index
              path="maintenance/message"
              element={<MessageAdminPage />}
            />
            <Route
              index
              path="maintenance/audit-trial"
              element={<AuditTrialAdminPage />}
            />
            <Route
              index
          ...
          <Route path="/staff" element={<StaffPage />}>
            ...
            <Route
              index
              path="service/ministry-record"
              element={<MinistryStaffPage />}
            />
            <Route
              index
              path="service/waterbaptism"
              element={<WaterBaptism_Page />}
            />
            <Route
              index
              path="service/child-dedication"
              element={<ChildDedicationPage />}
            />
            <Route
              index
              path="service/marriage-record"
              element={<MarriageServicePage />}
            />
          ...
          <Route path="/member" element={<MemberPage />}>
            ...
            <Route
              path="my-childdedication"
              element={<ChildDedicationMember />}
            />
