...
export const LearnMoreMinistries = () => {
    ...
    const { ministryModel } = location.state || {};
    const model: MinistryModel = ministryModel;
            ...
            <div className="w-screen h-auto items-center flex flex-col justify-center">
                <section className="relative h-[40vh] w-full flex items-center justify-center mt-20">
                    <div
                        ...
                        style={{
                            backgroundImage: `url("http://localhost:8081/bbek/ministry_image?ministryName=${encodeURIComponent(
                                model.ministryName
                            )}")`,
                    ...
                    <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                        <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 tracking-tight">{model.ministryName}</h1>
                        <p className="text-xl md:text-2xl text-white font-light">Ministry Details</p>
                    </div>
                            ...
                            <div className="max-w-4xl mx-auto">
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
                                    <div className="lg:col-span-2">
                                        <h2 className="text-3xl font-bold mb-6 text-black">About This Ministry</h2>
                                    ...
                                    <div className="lg:col-span-1 ">
                                        <div className="bg-blue-600 rounded-lg p-6 shadow-lg">
                                            <h3 className="text-xl font-bold mb-6">Ministry Details</h3>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-white">
                                                            {formatTime(model.startTime)} - {formatTime(model.endTime)}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-white">{model.leader}</p>
                                                    </div>
                                                </div>
                                ...
                                <div className="w-full flex justify-center items-center">
                                    <motion.button
                                        ...
                                        onClick={() => {
                                            navigate("/landpage/ministries/allministry");
                                        }}
                                    >
                                        Back to Ministry
                                    </motion.button>
