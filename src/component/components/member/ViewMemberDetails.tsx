...
export const ViewMemberDetails=(props:{memberDetails:MemberDetailsModel})=>{
    return(
            <div className="p-6">
            ...
            <div className="p-6 pt-0">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p>{props.memberDetails?.firstname} {props.memberDetails?.middlename} {props.memberDetails?.lastname}</p>
                </div>
                <div
                ...
                <div>
                  ...
                  <p>
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${props.memberDetails?.active? "bg-green-50":"bg-red-50"}`}
                    >
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p>{dayjs(props.memberDetails?.baptismDate).format("DD/MM/YYYY")}</p>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-500">
                            Baptism Officiant
