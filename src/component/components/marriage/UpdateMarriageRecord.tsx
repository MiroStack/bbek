...
import { hideUpdateMarriage } from "../../../datasource/redux/modules/church_record/MarriageSlice";
...
export const UpdateMarriageRecord = ({ marriageStatuses, marriageLocations, marriageRecord, setSelectedItem, setRefresh }: UpdateMarriageRecordProps) => {
    ...
    const handleSubmitMarriage = async (e:FormEvent) => {
        e.preventDefault();
        dispatch(showLoader());
        try {
