...
import { hideUpdateMinistry } from "../../../datasource/redux/modules/church_record/MinistrySlice";
...
export const UpdateMinistryForm = ({
  setIsRefresh,
}: UpdateMinistryFormProps) => {
  ...
  const getData = async () => {
    try {
      const response = await ministryRepo.getMinistryById(
          ...
          <div className="grid gap-2 relative">
            ...
            >
              ...
              <div
                ...
                } absolute bg-white w-100 border z-10  top-[150%] left-[50%] -translate-y-1/2 -translate-x-1/2`}
              >
                <ul className="flex flex-col items-start px-3 w-100">
