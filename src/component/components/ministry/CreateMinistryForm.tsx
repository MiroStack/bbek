...
import { hideMinistry } from "../../../datasource/redux/modules/church_record/MinistrySlice";
  ...
  const fetchDepartmentList = async () => {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setDepartment(response.data[1].departmentName);
      }
    } catch (e) {}
  };
          ...
          <div className="grid gap-2 relative">
            ...
            >
              ...
              <div
                className={`${
                  showSchedule ? "" : "hidden"
                } absolute bg-white w-100 border  top-[150%] left-[50%] -translate-y-1/2 -translate-x-1/2`}
              >
          ...
          <div className="grid gap-2 relative">
            ...
            >
              ...
              <div
                className={`${
                  showStatus ? "" : "hidden"
                } absolute bg-white z-10 w-100 border  top-[150%] left-[50%] -translate-y-1/2 -translate-x-1/2`}
              >
                <ul className="flex flex-col items-start px-3 w-100">
                  <li
                    className="hover:text-green-500"
          ...
          <div className="grid gap-2 relative">
            ...
            >
              ...
              <div
                ...
                } absolute bg-white w-100 border z-100  top-[150%] left-[50%] -translate-y-1/2 -translate-x-1/2`}
              >
                <ul className="flex flex-col items-start px-3 w-100">
                  {departmentList.map((d) => (
                    <li
                      ...
                      onClick={() => {
                        ...
                        setToggleDepartmentDropdown(false);
                      }}
                    >
                      {d.departmentName}
                    </li>
