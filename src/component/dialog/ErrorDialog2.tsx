...
import { hideErrorDialog} from "../../redux/dialog/DialogSlice.ts";
  ...
  const errorDialog = useAppSelector((state) => state.dialog.error);
    ...
    return (
        <>
            ...
            <div className={`${errorDialog ? "fixed" : "hidden"} bg-white w-[24rem] md:w-[30rem]  lg:w-[24rem]  h-[18rem] p-3  rounded-lg shadow-lg items-center justify-center flex-col z-[2000] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2`}>
